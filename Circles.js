...
import { AntDesign, MaterialIcons, MaterialCommunityIcons, FontAwesome, Entypo, Octicons, Ionicons, FontAwesome6, Feather, SimpleLineIcons } from '@expo/vector-icons';
...
const Circles = () => {
  ...
  const [messages, setMessages] = useState([
    ...
    { id: '2', text: 'Here are trending deals on Microsoft Office around you.', user: 'Bot' }, // Bot message
    {
      ...
      title: '@ccccrcles',
      description: 'In response to Taylor Swifts endorsement of Vice President Kamala Harris, Musk made a controversial remark, offering to give childless cat lady Taylor Swift a baby, which was widely criticized.',
      images: [
    ...
    },
    {
      ...
      images: [
        ...
        { uri: 'https://imageio.forbes.com/specials-images/imageserve/6659c0eacaa3c89097c832a7/0x0.jpg?format=jpg&crop=5453,3066,x0,y142,safe&height=900&width=1600&fit=bounds', name: 'Winter Jacket', price: '$129' },
    ...
    if (item.type === 'post') {
      return (
        <View style={styles.postCage}>
          <View style={styles.postContainer}>
            ...
            <View style={styles.reactionsContainer}>
              ...
              <TouchableOpacity style={styles.commentButton}>
                <SimpleLineIcons style={styles.commentText} name='bubbles' />
          ...
          <View style={styles.forwadContainer}>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        <TouchableOpacity onPress={handleSend} style={styles.sendButton}>
          <MaterialCommunityIcons name="pencil-outline" style={styles.sendButtonText} />
        </TouchableOpacity>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  forwardIcon: {
    ...
    backgroundColor: 'rgba(0, 28, 41, 0.8)',
    padding: 8,
    borderRadius: 100
  },
  postContainer: {
