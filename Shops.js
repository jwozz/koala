...
const Shops = () => {
  ...
  const [messages, setMessages] = useState([
    ...
    },
    {
      ...
      title: '@elonmusk',
      description: 'Starship Next Gen Upper Stage Rocket.',
      images: [
        { uri: 'https://media.nature.com/lw1200/magazine-assets/d41586-024-00029-4/d41586-024-00029-4_26608470.jpg', name: 'Artisan Bread', price: '$12' },
        { uri: 'https://today-obs.line-scdn.net/0hcumWw7WXPFpQLi63VPpDDWh4MCtjSCZTckp6aSd5YT0oAnMJOUxvOXx9YXZ0HykPcE17OiJ6Y2N8SShZbA/w644', name: 'Cheese Platter', price: '$29' },
        { uri: 'https://cdn.wccftech.com/wp-content/uploads/2024/09/SPACEX-STARSHIP-FLIGHT-6-STATIC-FIRE-UPPER-STAGE-1456x970.jpeg', name: 'Leather Boots', price: '$89' },
        ...
        <View style={styles.postCage}>
          <View style={styles.postContainer}>
            <View style={styles.postHeader}>
              ...
              <View style={styles.infoIconCage}>
                <TouchableOpacity style={styles.infoIcons}>
                  <Ionicons style={styles.iconText} name='location-outline' />
                  <Text style={styles.iconText}>Meru, Makutano</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.infoIcons}>
                  <MaterialCommunityIcons style={styles.iconText} name='message-reply-text-outline' />
            ...
            <View style={styles.actions}>
                <TouchableOpacity style={styles.callAction}>
                    <Text style={styles.actionText}>Views, 12k</Text>
                </TouchableOpacity>
                <View style={styles.share}>
                    <View style={styles.forwadContainer}>
                        <Ionicons style={styles.forwardIcon} name='heart-outline' />
                    </View>
                    <View style={styles.forwadContainer}>
